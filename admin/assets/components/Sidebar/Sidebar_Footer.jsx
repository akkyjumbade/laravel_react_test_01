export default function Sidebar_Footer() {
   return (
      ...
      <UserMenu />
            ...
            <div className="docs-info text-gray-400">
               <h6 className="text-white text-sm up mb-0">Need help?</h6>
               <p className="text-xs font-weight-bold">Please check our docs</p>
               <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard" target="_blank" className="btn btn-white btn-sm text-sm w-100 mb-0">Documentation</a>
            </div>
         </div>
